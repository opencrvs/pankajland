...
export const SPC_CODING_DATABASE_URL = env.SPC_CODING_DATABASE_URL
export const SPC_CLIENT_ID = env.SPC_CLIENT_ID
export const SPC_CLIENT_SECRET = env.SPC_CLIENT_SECRET
export const SPC_AUTH_URL = env.SPC_AUTH_URL
export const SPC_COUNTRY_CONFIG_URL = env.SPC_COUNTRY_CONFIG_URL
