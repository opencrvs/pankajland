...
const mockDatabase: Map<string, DeathRecord> = new Map([
  ['CERT-2026-001234', { id: 'CERT-2026-001234', deceased: 'John Doe', causeOfDeath: [], dateOfDeath: '2024-01-15' }],
  ['CERT-2026-002456', { id: 'CERT-2026-002456', deceased: 'Jane Smith', causeOfDeath: [], dateOfDeath: '2024-02-20' }],
  ['CERT-2026-003789', { id: 'CERT-2026-003789', deceased: 'Bob Johnson', causeOfDeath: [], dateOfDeath: '2024-03-10' }],
  ['CERT-2026-004012', { id: 'CERT-2026-004012', deceased: 'Alice Brown', causeOfDeath: [], dateOfDeath: '2024-04-05' }],
  ['CERT-2026-005345', { id: 'CERT-2026-005345', deceased: 'Charlie Wilson', causeOfDeath: [], dateOfDeath: '2024-05-12' }],
]);
  ...
  export const mockReadyRecords: DatabaseRecord[] = [
    {
      ...
      certificateKey: "CERT-2026-001234",
      ucCode: "I21.9",
    ...
    },
    {
      ...
      certificateKey: "CERT-2026-002456",
      ucCode: "J18.9",
      selectedCodes: "J44.0",
      multipleCodes: "I50.9"
    },
    {
      ...
      certificateKey: "CERT-2026-003789",
      ucCode: "C34.9",
      selectedCodes: "F17.2",
      multipleCodes: ""
    },
    {
      ...
      certificateKey: "CERT-2026-004012",
      ucCode: "I25.1",
    ...
    },
    {
      ...
      certificateKey: "CERT-2026-005345",
      ucCode: "N18.9",
