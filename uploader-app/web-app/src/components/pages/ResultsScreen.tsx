      ...
      <div className="w-full max-w-4xl">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600">
            Records from the SPC Mortality Group have been processed. Review the
            results below.
          </p>
        </div>
                ...
                <Accordion.Item key={index} value={`item-${index}`}>
                  ...
                  <Accordion.Panel>
                    <div className="space-y-2">
                      ...
                      {result.irisRejectionReason && (
                        <Text size="sm">
                          <strong>Reason for rejection added:</strong>{' '}
                          {result.irisRejectionReason}
                        </Text>
                      )}
                    </div>
        ...
        {rejectedRecords.length > 0 && (
          ...
          >
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <Text size="lg" fw={700} c="red.9" mb={2}>
                    ...
                    {rejectedRecords.length !== 1 ? 's have' : ' has'} been
                    corrected with the reason for rejection by the coding group
                  </Text>
                  <Text size="sm" c="red.8" fw={500}>
                    ⚠️ IMPORTANT: This is your last chance to copy this list so
                    that you can easily find these records and make any
                    necessary corrections should you wish the SPC Mortality
                    Coding Group to attempt to re-code these records again.
                  </Text>
                </div>
              </div>
              <Button
                ...
                className="flex-shrink-0 min-w-[120px] justify-center"
              >
            ...
            <ScrollArea
              h={250}
              className="bg-white rounded border-2 border-red-200 p-4"
            >
